...
const api = {
  ...
  kbListProjects: () => ipcRenderer.invoke("kb:listProjects"),
  kbCreateProject: (name: string) => ipcRenderer.invoke("kb:createProject", name),
  kbUploadDocuments: (project: string, files: KbUploadFileInput[]) =>
    ipcRenderer.invoke("kb:uploadDocuments", project, files),
  kbListDocuments: (project: string) => ipcRenderer.invoke("kb:listDocuments", project),
  kbReadMarkdown: (project: string, docName: string) => ipcRenderer.invoke("kb:readMarkdown", project, docName),
  kbDeleteSource: (project: string, docName: string) => ipcRenderer.invoke("kb:deleteSource", project, docName),
  kbRescan: (project: string) => ipcRenderer.invoke("kb:rescan", project),
  kbSearch: (project: string, query: string) => ipcRenderer.invoke("kb:search", project, query),
  kbChat: (project: string, query: string, history?: KbChatHistoryMessage[]) =>
    ipcRenderer.invoke("kb:chat", project, query, history),
  kbListWikiPages: (project: string) => ipcRenderer.invoke("kb:listWikiPages", project),
  kbReadWikiPage: (project: string, relPath: string) => ipcRenderer.invoke("kb:readWikiPage", project, relPath),
  kbWikiGraph: (project: string) => ipcRenderer.invoke("kb:wikiGraph", project),
  ...
  kbDeleteGraphTemplate: (name: string) => ipcRenderer.invoke("kb:deleteGraphTemplate", name),
  kbGraphExtract: (project: string, docName: string, templateName: string) =>
    ipcRenderer.invoke("kb:graphExtract", project, docName, templateName),
  kbGraphStatus: (project: string, docName: string) => ipcRenderer.invoke("kb:graphStatus", project, docName),
  kbGraphView: (project: string, docName: string, templateName: string) =>
    ipcRenderer.invoke("kb:graphView", project, docName, templateName),
