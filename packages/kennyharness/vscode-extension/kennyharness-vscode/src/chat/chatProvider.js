...
function getLaunchConfig() {
  const cfg = vscode.workspace.getConfiguration('kennyharness');
  const command = cfg.get('launchCommand', 'kennyharness');
...
class KennyHarnessChatViewProvider {
...
class KennyHarnessChatPanelManager {
  constructor(chatController) {
    this._chatController = chatController;
    this._panel = null;
  }
