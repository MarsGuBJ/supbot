/**
 * ProcessManager — spawns KennyHarness in print/SDK mode and manages the
...
class ProcessManager {
  /**
   * @param {object} opts
   * @param {string} opts.command - The kennyharness binary (e.g. 'kennyharness')
   ...
   */
  constructor(opts) {
    this._command = opts.command || 'kennyharness';
