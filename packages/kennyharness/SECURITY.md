...
KennyHarness is currently maintained on the latest `main` branch and the latest
npm release only.
...
If you believe you have found a security vulnerability in KennyHarness, please
report it privately.
...
- the KennyHarness source code in this repository
- official release artifacts published from this repository
- the `kennyharness` npm package
