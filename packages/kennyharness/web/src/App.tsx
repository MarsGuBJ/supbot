...
function App() {
  ...
  useEffect(() => {
    ...
    try {
      localStorage.setItem('kennyharness-theme', theme)
    } catch {
      /* storage unavailable */
    }
  }, [theme])
    ...
    <div className="site-shell">
      <header className="site-header">
        <nav className="nav" aria-label="primary">
          <a className="brand" href="/" aria-label="kennyharness home">
            <img src="/kennyharness.png" alt="" />
            <span>kennyharness</span>
          ...
          <div className="install-grid">
            ...
            <ol className="install-steps">
              ...
              <li>
                ...
                <div>
                  <strong>start</strong>
                  <p>run <code>kennyharness</code> in any repo.</p>
                </div>
              </li>
              <li>
      ...
      <footer className="footer">
        <div className="footer-line">
          ...
          <span className="sep">|</span>
          <a href="https://github.com/Gitlawb/kennyharness/blob/main/LICENSE">license</a>
          <span className="sep">·</span>
  ...
  return (
    <section className="hero" aria-labelledby="hero-heading">
      ...
      <div className="hero-cta">
        ...
        <a className="button button-ghost" href="https://github.com/Gitlawb/kennyharness">
          view on github →
        </a>
      </div>
