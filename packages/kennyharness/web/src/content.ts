export const installCommand = 'npm install -g kennyharness@latest'
...
export const features = [
  ...
  },
  {
    ...
    body: 'save model, base url, auth, and runtime defaults to .kennyharness-profile.json so every clone boots the same way.',
  },
  {
...
export const navLinks = [
  ...
  { href: 'https://github.com/Gitlawb/kennyharness', label: 'github' },
  { href: 'https://gitlawb.com/node/repos/z6MkqDnb/kennyharness', label: 'gitlawb' },
] as const
