# KennyHarness for Non-Technical Users
...
## What KennyHarness Does

KennyHarness lets you use an AI coding assistant with different model providers such as:
...
1. Install KennyHarness with npm
...
After you run `kennyharness`, the CLI should start and wait for your prompt.
...
### `kennyharness` command not found
