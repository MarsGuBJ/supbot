# KennyHarness Quick Start for Windows
...
## 4. If `kennyharness` Is Not Found
...
If PowerShell still says `kennyharness` is not recognized, npm's global bin
...
## 6. Updating KennyHarness

```powershell
npm install -g kennyharness@latest
```

## 7. Uninstalling KennyHarness

```powershell
npm uninstall -g kennyharness
```
