...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/kennyharness.proto')
...
async function main() {
  ...
  const client = new kennyharnessProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mKennyHarness gRPC CLI\x1b[0m')
