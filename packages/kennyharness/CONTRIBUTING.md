# Contributing to KennyHarness

Thanks for contributing.

KennyHarness is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/Gitlawb/kennyharness/issues) and [discussions](https://github.com/Gitlawb/kennyharness/discussions) before opening a new thread.
...
KennyHarness supports multiple provider paths. If you change provider logic:
