...
export function CancelRequestHandler(props: CancelRequestHandlerProps): null {
  ...
  const handleCancel = useCallback(() => {
    ...
    // This takes precedence over queue management so users can always interrupt KennyHarness
    ...
    // Priority 2: Pop queue when KennyHarness is idle (no running task to cancel)
