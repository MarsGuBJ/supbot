...
describe('sessionPersistence', () => {
  const testSessionDir = join(process.env.TEMP_DIR ?? '/tmp', 'kennyharness-test-sessions')

  beforeEach(async () => {
    process.env.KENNYHARNESS_TEST_SESSIONS_DIR = testSessionDir
  ...
  afterEach(() => {
    delete process.env.KENNYHARNESS_TEST_SESSIONS_DIR
  })
