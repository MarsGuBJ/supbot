export const BASE_CHROME_PROMPT = `# Browser control in Chrome
...
/**
 * Minimal hint about browser control in Chrome skill availability. This is injected at startup when the extension is installed
