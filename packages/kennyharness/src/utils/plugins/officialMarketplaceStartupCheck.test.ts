...
mock.module('../config.js', () => ({
  ...
  getManagedClaudeRulesDir: () => '/tmp/kennyharness-managed-rules',
  getMemoryPath: () => '/tmp/kennyharness-memory.md',
  getOrCreateUserID: () => 'test-user-id',
  getProjectPathForConfig: () => '/tmp/kennyharness-project-config.json',
  getRemoteControlAtStartup: () => false,
  getUserClaudeRulesDir: () => '/tmp/kennyharness-user-rules',
...
mock.module('./marketplaceManager.js', () => ({
  ...
  getMarketplacesCacheDir: () => '/tmp/kennyharness-marketplaces',
  ...
  test('uses known marketplaces as the installed source of truth', async () => {
    knownMarketplaces = {
      'claude-plugins-official': {
        installLocation: '/tmp/kennyharness-marketplaces/claude-plugins-official',
      },
    }
