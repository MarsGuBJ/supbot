...
export const KENNYHARNESS_RELEASES_URL =
  'https://github.com/Gitlawb/kennyharness/releases'
...
export function getReleaseTagUrl(version: string = publicBuildVersion): string {
  return `${KENNYHARNESS_RELEASES_URL}/tag/v${normalizePublicVersion(version)}`
}
