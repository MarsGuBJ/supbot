/**
 * Adapter layer that wraps @anthropic-ai/sandbox-runtime with KennyHarness CLI-specific integrations.
 * This file provides the bridge between the external sandbox-runtime package and KennyHarness CLI's
...
/**
 * Resolve KennyHarness-specific path patterns for sandbox-runtime.
 *
 * KennyHarness uses special path prefixes in permission rules:
...
/**
 * Convert KennyHarness settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // Always include current directory and KennyHarness temp directory as writable
  ...
  // This blocks settings in the original working directory (where KennyHarness started)
  ...
  // (auto-discovered, auto-loaded, full KennyHarness capabilities) so they need the
  ...
  // core.fsmonitor) escapes the sandbox when KennyHarness's unsandboxed git runs.
  //
...
// ============================================================================
// KennyHarness CLI-specific state
// ============================================================================
 ...
 * KennyHarness's unsandboxed git calls can see them. See the SECURITY block above
 ...
 * This is a KennyHarness CLI-specific function that updates local settings.
 */
...
/**
 * KennyHarness CLI sandbox manager - wraps sandbox-runtime with KennyHarness-specific features
 */
