 ...
 *
 * Usage:
 *   kennyharness --provider openai --model gpt-4o
 *   kennyharness --provider gemini --model gemini-2.0-flash
 *   kennyharness --provider mistral --model ministral-3b-latest
 *   kennyharness --provider ollama --model llama3.2
 *   kennyharness --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `kennyharness --model <name>` should work standalone so users can
