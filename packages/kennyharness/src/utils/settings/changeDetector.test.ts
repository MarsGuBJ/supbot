...
const pathsBySource: Record<SettingSource, string | null> = {
  userSettings: normalize('/tmp/kennyharness/user/settings.json'),
  projectSettings: normalize('/tmp/kennyharness/project/.claude/settings.json'),
  localSettings: normalize('/tmp/kennyharness/project/.claude/settings.local.json'),
  flagSettings: null,
  policySettings: normalize('/tmp/kennyharness/managed/managed-settings.json'),
}
...
async function importFreshModule(): Promise<SettingsChangeDetectorModule> {
  ...
  activeDetector._setDependenciesForTesting({
    ...
    getManagedSettingsDropInDir: () =>
      normalize('/tmp/kennyharness/managed/managed-settings.d'),
