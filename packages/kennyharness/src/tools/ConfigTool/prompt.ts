...
export const DESCRIPTION = 'Get or set KennyHarness configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set KennyHarness configuration settings.

  View or change KennyHarness settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.kennyharness.json)
${globalSettings.join('\n')}
