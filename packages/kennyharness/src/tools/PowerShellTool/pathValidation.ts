...
function checkPathConstraintsForStatement(
  ...
  // Runtime writes /project/.claude/settings.json (the agent's permission config).
  //
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, KennyHarness may only access files in the allowed working directories for this session: ${dirListStr}.`
