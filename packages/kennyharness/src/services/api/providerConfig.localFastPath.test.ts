...
const ENV_VAR = 'KENNYHARNESS_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('KENNYHARNESS_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('KENNYHARNESS_LOCAL_FAST_PATH=0 forces off against localhost', () => {
