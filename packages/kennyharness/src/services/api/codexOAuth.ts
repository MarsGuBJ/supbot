...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to KennyHarness now.</p>
    <p>KennyHarness will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in KennyHarness.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in KennyHarness.</p>
  </body>
</html>`
}
