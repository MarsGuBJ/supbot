...
// Lazy: toolRendering.tsx pulls React/ink; only needed when the Chrome browser-control MCP server is connected
/* eslint-disable @typescript-eslint/no-require-imports */
      ...
      const client = new Client(
        {
          ...
          description: 'KennyHarness — coding-agent CLI for any LLM provider',
