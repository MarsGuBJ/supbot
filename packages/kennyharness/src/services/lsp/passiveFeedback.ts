...
/**
 * Map LSP severity to KennyHarness diagnostic severity
 *
 * Maps LSP severity numbers to KennyHarness diagnostic severity strings.
...
/**
 * Convert LSP diagnostics to KennyHarness diagnostic format
 *
 * Converts LSP PublishDiagnosticsParams to DiagnosticFile[] format
 * used by KennyHarness's attachment system.
 */
 ...
 * from all LSP servers and routes them to KennyHarness's diagnostic system.
      ...
      serverInstance.onNotification(
        ...
        (params: unknown) => {
          ...
          try {
            ...
            // Convert LSP diagnostics to KennyHarness format (can throw on invalid URIs)
