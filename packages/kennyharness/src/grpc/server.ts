...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/kennyharness.proto')
...
const kennyharnessProto = protoDescriptor.kennyharness.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(kennyharnessProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register KennyHarness's built-in agents (general-purpose,
