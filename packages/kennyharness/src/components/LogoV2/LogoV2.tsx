...
export function LogoV2() {
  ...
  const borderTitle = ` ${color("text", userTheme)("KennyHarness")} ${color("inactive", userTheme)(`v${version}`)} `;
  const compactBorderTitle = color("text", userTheme)(" KennyHarness ");
