 ...
 * users think of as "a new message from KennyHarness" — not raw assistant entries
 ...
 * until KennyHarness's text response lands.
 */
...
// conversation turn's prompt above the viewport so you know what KennyHarness was
