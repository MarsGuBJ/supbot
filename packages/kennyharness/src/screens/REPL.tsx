...
export function REPL({
  ...
  const terminalTitle = sessionTitle ?? agentTitle ?? haikuTitle ?? 'KennyHarness';
  ...
  // That write storm is the primary trigger for ~/.kennyharness.json corruption
  // (GH #3117).
  ...
  useEffect(() => {
    const handleSuspend = () => {
      ...
      process.stdout.write(`\nKennyHarness has been suspended. Run \`fg\` to bring KennyHarness back.\nNote: ctrl + z now suspends KennyHarness, ctrl + _ undoes input.\n`);
    };
    const handleResume = () => {
