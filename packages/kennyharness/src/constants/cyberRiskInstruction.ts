 ...
 *
 * This instruction provides guidance for KennyHarness's behavior when handling
 ...
 *   - How KennyHarness handles penetration testing and CTF requests
 *   - What security tools and techniques KennyHarness will assist with
 ...
 *
 * KennyHarness: Do not edit this file unless explicitly asked to do so by the user.
 */
