...
export default defineGateway({
  ...
  catalog: {
    ...
    models: [
      ...
      // Anthropic family — /zen/v1/messages
      { id: 'claude-opus-4-7', apiName: 'claude-opus-4-7', label: 'Anthropic Opus 4.7', modelDescriptorId: 'opencode-claude-opus-4-7', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-opus-4-6', apiName: 'claude-opus-4-6', label: 'Anthropic Opus 4.6', modelDescriptorId: 'opencode-claude-opus-4-6', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-opus-4-5', apiName: 'claude-opus-4-5', label: 'Anthropic Opus 4.5', modelDescriptorId: 'opencode-claude-opus-4-5', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-opus-4-1', apiName: 'claude-opus-4-1', label: 'Anthropic Opus 4.1', modelDescriptorId: 'opencode-claude-opus-4-1', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-sonnet-4-6', apiName: 'claude-sonnet-4-6', label: 'Anthropic Sonnet 4.6', modelDescriptorId: 'opencode-claude-sonnet-4-6', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-sonnet-4-5', apiName: 'claude-sonnet-4-5', label: 'Anthropic Sonnet 4.5', modelDescriptorId: 'opencode-claude-sonnet-4-5', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-sonnet-4', apiName: 'claude-sonnet-4', label: 'Anthropic Sonnet 4', modelDescriptorId: 'opencode-claude-sonnet-4', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-haiku-4-5', apiName: 'claude-haiku-4-5', label: 'Anthropic Haiku 4.5', modelDescriptorId: 'opencode-claude-haiku-4-5', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
      { id: 'claude-3-5-haiku', apiName: 'claude-3-5-haiku', label: 'Anthropic Haiku 3.5', modelDescriptorId: 'opencode-claude-3-5-haiku', transportOverrides: { openaiShim: { endpointPath: '/messages' } } },
