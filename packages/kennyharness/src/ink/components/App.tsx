...
export default class App extends PureComponent<Props, State> {
  ...
  stdinMode: 'readable' | 'data' = process.env.KENNYHARNESS_USE_DATA_STDIN === '1' || process.env.KENNYHARNESS_USE_READABLE_STDIN === '0' ? 'data' : 'readable';
  ...
  handleSuspend = (): void => {
    ...
    // Emit suspend event for KennyHarness to handle. Mostly just has a notification
    ...
    const resumeHandler = () => {
      ...
      // Emit resume event for KennyHarness to handle
