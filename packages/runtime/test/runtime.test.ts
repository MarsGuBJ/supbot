...
describe("SupbotRuntime", () => {
  test("defaults model max tokens to 200K and preserves that value when saved", async () => {
    ...
    expect(saved.maxTokens).toBe(200_000);
    expect(runtime.snapshot().modelConfig.maxTokens).toBe(200_000);
  });
