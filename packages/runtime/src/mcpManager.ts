...
function invalidMcpConfigTransfer(): Error {
  return new Error("Invalid MCP config transfer. Expected a HyWork export or an MCP servers object.");
}
...
const mcpServerPresets: McpServerPreset[] = [
  ...
  },
  {
    ...
    docsUrl: "https://modelcontextprotocol.io",
    riskNote:
      "Does not install from HyWork, but npx may execute package code available on this machine or registry cache.",
    serverInput: {
      name: "npx-mcp",
      command: "npx",
